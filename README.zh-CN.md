...
eval_harness/      评测引擎：data_correctness + advisor_grounding + attribution_grounding（确定性 gate）+ LLM-judge（reasoning_quality / insight_novelty / claim_coverage）；evalcli 共享装配 + 任务内联 fixture
